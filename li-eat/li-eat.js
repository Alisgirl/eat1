...
async function getProducts() {
    try {
        ...
        return [
            {title: "Wolfberry juice", description: "Сік із вовчих гаків", price: 150, image: "монвода.png"},
            {title: "Holy water", description: "Свята вода", price: 100, image: "монвода1.png"},
            {title: "Apple drink", description: "Яблучний напій", price: 200, image: "монвода2.png"},
            {title: "Berry drink with mint", description: "Ягідний напій з м'ятою", price: 80, image: "монвода3.png"},
            {title: "Festive juice", description: "Святковий сік", price: 50, image: "juice.png"}
        ];
    }
}
